...
namespace harp::com {
     ...
     */
    template<class TYPE>
    std::vector<ds::Table<TYPE> *> *Communicator::gatherAsPartitions(harp::ds::Table<TYPE> *table, int rootWorkerId) {
     ...
     */
    template<class TYPE>
    std::vector<ds::Table<TYPE> *> *Communicator::gatherAsOneArray(harp::ds::Table<TYPE> *table, int rootWorkerId) {
     ...
     */
    template<class TYPE>
    std::vector<ds::Table<TYPE> *> *Communicator::allGatherAsPartitions(harp::ds::Table<TYPE> *table) {
        // first gather all TableInfo sizes from all workers
        int tableInfoSizes[worldSize];
        ds::TableInfo tableInfo(table);
        int tableInfoSize = tableInfo.getSerializedSize();
     ...
     */
    template<class TYPE>
    std::vector<ds::Table<TYPE> *> *Communicator::allGatherAsOneArray(harp::ds::Table<TYPE> *table) {
        // first gather all TableInfo sizes from all workers
        int tableInfoSizes[worldSize];
        ds::TableInfo tableInfo(table);
        int tableInfoSize = tableInfo.getSerializedSize();
     ...
     */
    template<class TYPE>
    void Communicator::allReduceAsOneArray(harp::ds::Table<TYPE> *table, MPI_Op operation) {
        MPI_Datatype dataType = getMPIDataType<TYPE>();
     ...
     */
    template<class TYPE>
    void Communicator::allReduceAsPartitions(harp::ds::Table<TYPE> *table, MPI_Op operation) {
        MPI_Datatype dataType = getMPIDataType<TYPE>();
     ...
     */
    template<class TYPE>
    void Communicator::broadcastAsPartitions(harp::ds::Table<TYPE> *table, int bcastWorkerId) {
     ...
     */
    template<class TYPE>
    void Communicator::broadcastAsOneArray(harp::ds::Table<TYPE> *table, int bcastWorkerId) {
        // first we broadcast TableInfo size
        int tableInfoSize;
        ds::TableInfo *tableInfo;
        if (bcastWorkerId == this->workerId) {
    ...
    template<class TYPE>
    void Communicator::rotate(harp::ds::Table<TYPE> *table, int sendTag, int recvTag) {
        MPI_Datatype dataType = getMPIDataType<TYPE>();
    ...
    template<class TYPE>
    void Communicator::asyncRotate(harp::ds::Table<TYPE> *table, int pid) {
